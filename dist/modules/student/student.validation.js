...
exports.imageUploadSchema = exports.stipendBeneficiarySchema = exports.bulkPromoteSchema = exports.promoteSchema = exports.updateStatusSchema = exports.listQuerySchema = exports.createStudentSchema = exports.genderEnum = void 0;
// // // /**
// // //  * 🌐 Localized text
// // //  */
...
exports.createStudentSchema = zod_1.z.object({
    studentUid: zod_1.z.string().min(1, "Student UID required"),
    name: zod_1.z.object({
    ...
    father: zod_1.z.object({
        name: zod_1.z.object({ en: zod_1.z.string().optional(), bn: zod_1.z.string().optional() }).optional(),
...
exports.listQuerySchema = zod_1.z.object({
    ...
    gender: exports.genderEnum.optional(), // ✅ Gender type ঠিক করা
    status: zod_1.z
        .enum(["active", "repeat", "passed", "transferred", "archived"])
        .optional(),
    sortBy: zod_1.z.enum(["name", "class", "roll", "createdAt"]).optional(),
    sortDir: zod_1.z.enum(["asc", "desc"]).optional(),
    religion: zod_1.z.string().optional(),
    ageMin: zod_1.z.string().optional().transform(Number),
    ageMax: zod_1.z.string().optional().transform(Number),
});
// ──────────────────────────────────────────────────────────────
// Update Status Schema
// ──────────────────────────────────────────────────────────────
...
exports.promoteSchema = zod_1.z.object({
    session: zod_1.z.string().min(1, "Session required"),
    fromClass: zod_1.z.coerce.number().min(1),
    toClass: zod_1.z.coerce.number().min(1),
    result: zod_1.z.enum(["promoted", "repeat"]),
    previousRoll: zod_1.z.coerce.number().optional(),
    newRoll: zod_1.z.coerce.number().optional(),
...
exports.bulkPromoteSchema = zod_1.z.object({
    ...
    fromClass: zod_1.z.coerce.number().min(1),
    toClass: zod_1.z.coerce.number().min(1),
    studentUids: zod_1.z.array(zod_1.z.string()).min(1),
    result: zod_1.z.enum(["promoted", "repeat"]),
    remarks: zod_1.z.string().optional(),
});
...
exports.stipendBeneficiarySchema = zod_1.z.object({
    ...
    mobile: zod_1.z.string().min(1, "Mobile required"),
